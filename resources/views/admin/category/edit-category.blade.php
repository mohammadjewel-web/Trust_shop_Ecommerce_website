            ...
            <div class="col-lg-4" style="margin-left: 242px">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Edit Category From</strong>
                        <p class="text-center text-success ">{{ session('message') }}</p>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('category') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input value="{{ $category->id }}" name="cat_id" type="hidden"/>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-borderless table-hover">
                            <thead>
                            <tr>
                                <th class="col-form-label">SL NO</th>
                                <th>Image</th>
                                <th>Category Name</th>
                                <th>Status</th>
                                <th>Action</th>
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    <td class="text-muted col-form-label">{{ $i++ }}</td>
