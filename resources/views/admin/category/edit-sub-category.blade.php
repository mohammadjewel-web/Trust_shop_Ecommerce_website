            ...
            <div class="col-lg-4" style="margin-left: 242px">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Edit Sub Category Form</strong>
                        <p class="text-center text-success ">{{ session('message') }}</p>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('update-sub-category', ['id' => $sub_category->id]) }}" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sub_category_name"
                                           value="{{$sub_category->sub_category_name}}" class="form-control"
                                           id="inputPassword3">
                                </div>
                            </div>
